 ...
 */
define('WP_HOME', 'http://172.20.10.6/New/web_desa_tanjung_rambutan/wordpress-backend');
define('WP_SITEURL', 'http://172.20.10.6/New/web_desa_tanjung_rambutan/wordpress-backend');

/**
 * Allow WordPress to be accessed from different domains
 */
$_SERVER['HTTP_HOST'] = '172.20.10.6';
